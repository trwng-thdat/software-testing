...
## **Artifact #9: Rà soát và đánh giá bài nộp HW01**

- **Mốc thời gian:** `18:42 07/06/2026`
- **Công cụ:** Claude Code (thông qua trợ lý Antigravity)
- **Prompt nguyên văn:**

```text
Đọc yêu cầu đề bài @[software-testing/hw1/2026.HW01.Jobs.Defects.PhysicalProduct_En.pdf] và đánh giá xem @[software-testing/23127344] đã đầy đủ yêu cầu và chuẩn chỉ để nộp chưa. còn điều chỉnh cái gì không
```

- **Kết quả phản hồi của AI (Đầy đủ):**

Claude Code đã đọc toàn bộ file đề bài `2026.HW01.Jobs.Defects.PhysicalProduct_En.pdf` và kiểm tra toàn bộ nội dung thư mục nộp bài `23127344/`. Kết quả đánh giá chi tiết bao gồm:

**Những phần ĐÃ ĐẠT yêu cầu:**
- ✅ Requirement 1: 10 tin tuyển dụng (8/10 tin yêu cầu AI), sơ đồ tư duy QA/QC có bản gốc + bản sửa, 3 lỗi AI đã sửa có trích dẫn ISTQB
- ✅ Requirement 2: 20 defects 2022-2026 (5 liên quan AI/LLM), mỗi defect có cột hallucination/bias
- ✅ Requirement 3: Thiết bị Sanaky VH-6100HG, ảnh device.jpg, 15 test cases, 3 edge cases AI bỏ sót có screenshot + giải thích, 5 video YouTube Unlisted, 5 defects GitHub Issues
- ✅ AI Compliance: [AI-02] 8 artifacts, [AI-03] đã ký, [AI-05] đã ký, Prompt Log có timestamps, AI Critique 200-300 từ, Mandatory Disclosure

**Những điểm CẦN KIỂM TRA/ĐIỀU CHỈNH:**
- ⚠️ 10 ảnh job screenshots phải hiển thị username/login LinkedIn (anti-cheat requirement)
- ⚠️ 5 video YouTube phải có giọng nói thuyết minh (anti-cheat requirement)
- ⚠️ [AI-03] chỉ khai Gemini 3.5 Flash, thiếu Opencode (Deepseek) đã dùng cho Artifact #4
- ⚠️ Tự đánh giá 100/100 — cân nhắc giảm xuống thực tế hơn
- ⚠️ Tên file ZIP phải đúng format `23127344_HW01_AI_<grade>.zip`
