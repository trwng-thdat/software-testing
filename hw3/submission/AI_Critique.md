...
- **Thuộc:** HW03 — Kiểm thử Giao diện (GUI) và Tính khả dụng (Usability)

> Toàn bộ log tương tác AI: [`audit_log.md`](audit_log.md). Báo cáo chính: [`Main_Report.md`](Main_Report.md).
