...
| ---------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------- | ------------ | ------------ | ---------- |
| BUG-GUI-01 | HOME-U01           | Trang Home có 2 thẻ `<h1>` (Home.jsx:43, 110), vi phạm FR-05/FR-21 — **xác nhận qua thực thi**                                    | Low          | TODO         | [HOME-U01.png](screenshot/HOME-U01.png) |
| BUG-GUI-02 | HOME-U02           | Ảnh sản phẩm có `alt=""` rỗng, vi phạm FR-24 (accessibility) — **xác nhận qua thực thi**                                          | Medium       | TODO         | [HOME-U02.png](screenshot/HOME-U02.png) |
| BUG-GUI-03 | HOME-U03           | Giá hiển thị đơn vị "VND" thay vì ký hiệu `₫` theo FR-21 — **xác nhận qua thực thi**                                              | Low          | TODO         | [HOME-U03.png](screenshot/HOME-U03.png) |
| BUG-GUI-04 | HOME-F04           | Reflected XSS: từ khóa tìm kiếm render qua `dangerouslySetInnerHTML` không escape (Home.jsx:64) — **xác nhận qua thực thi** (payload HTML thực thi thành thẻ thật trong DOM) | **Critical** | TODO         | [HOME-F04.png](screenshot/HOME-F04.png) |
| BUG-GUI-05 | HOME-S01           | Không có trạng thái loading khi tải danh sách sản phẩm — **xác nhận qua thực thi**                                                | Medium       | TODO         | [HOME-S01.png](screenshot/HOME-S01.png) |
| BUG-GUI-06 | HOME-S02           | Không có empty state khi tìm kiếm không ra kết quả — **xác nhận qua thực thi**                                                    | Medium       | TODO         | [HOME-S02.png](screenshot/HOME-S02.png) |
| BUG-GUI-07 | HOME-S03           | SQL Injection xác nhận qua thực thi: payload `' OR '1'='1` trong ô tìm kiếm trả về toàn bộ sản phẩm thay vì 0 kết quả — `server.js:144` nối chuỗi trực tiếp vào `LIKE`, vi phạm SEC-05. Kịch bản lỗi 500 hiển thị thô ban đầu dự đoán chưa tái hiện được (cần tắt backend thủ công để verify riêng phần đó) | **Critical** | TODO         | [HOME-S03.png](screenshot/HOME-S03.png) |
| BUG-GUI-08 | HOME-N03, HOME-N04 | Navbar không highlight trang hiện tại; link Giỏ hàng không có badge số lượng, vi phạm FR-23 — **xác nhận qua thực thi**            | Medium       | TODO         | [HOME-N03.png](screenshot/HOME-N03.png), [HOME-N04.png](screenshot/HOME-N04.png) |
| BUG-GUI-09 | LOGIN-U01          | Trang Login hiển thị tiêu đề "Đăng Ký" (copy-paste lỗi từ Register) — **xác nhận qua thực thi**                                   | Medium       | TODO         | [LOGIN-U01.png](screenshot/LOGIN-U01.png) |
| BUG-GUI-10 | LOGIN-U02          | Nhãn "Username" và nút "Sign In" bằng tiếng Anh giữa giao diện tiếng Việt, vi phạm FR-21 — **xác nhận qua thực thi**              | Low          | TODO         | [LOGIN-U02.png](screenshot/LOGIN-U02.png) |
| BUG-GUI-11 | LOGIN-F01          | Trường Email dùng `type="text"` thay vì `type="email"`, vi phạm FR-02/FR-22 — **xác nhận qua thực thi**                           | Low          | TODO         | [LOGIN-F01.png](screenshot/LOGIN-F01.png) |
| BUG-GUI-12 | LOGIN-F02          | Trường Mật khẩu dùng `type="text"`: mật khẩu hiển thị rõ khi gõ, vi phạm FR-22 (Shoulder-surfing risk) — **xác nhận qua thực thi** | **High**     | TODO         | [LOGIN-F02.png](screenshot/LOGIN-F02.png) |
| BUG-GUI-13 | LOGIN-F03          | Thiếu ký hiệu `*` cho trường bắt buộc, vi phạm FR-22 — **xác nhận qua thực thi**                                                  | Low          | TODO         | [LOGIN-F03.png](screenshot/LOGIN-F03.png) |
| BUG-GUI-14 | LOGIN-F05          | Thông báo lỗi đăng nhập hiển thị dưới nút submit thay vì trên, vi phạm FR-22 — **xác nhận qua thực thi** (so sánh toạ độ Y)        | Low          | TODO         | [LOGIN-F05.png](screenshot/LOGIN-F05.png) |
| BUG-GUI-15 | LOGIN-S02          | Không có trạng thái loading/disable nút khi đang gọi API đăng nhập → nguy cơ double-submit — **xác nhận qua thực thi**            | Medium       | TODO         | [LOGIN-S02.png](screenshot/LOGIN-S02.png) |
| BUG-GUI-16 | LOGIN-S03          | Bộ đếm đăng nhập sai tăng +2/lần thay vì +1, vi phạm FR-02 (server.js:54) — nghi vấn từ code, **chưa đo lặp lại đủ số lần để khẳng định tuyệt đối qua thực thi** (xem ghi chú LOGIN-S03) | Medium       | TODO         | [LOGIN-S03.png](screenshot/LOGIN-S03.png) |
| BUG-GUI-17 | LOGIN-S04          | Thời gian khóa tài khoản là ~180 giây thay vì 30 giây theo spec (server.js:57) — **xác nhận qua thực thi** (API vẫn 403 sau 32s)   | Medium       | TODO         | [LOGIN-S04.png](screenshot/LOGIN-S04.png) |
| BUG-GUI-18 | LOGIN-S05          | Frontend không phân biệt lỗi "sai mật khẩu" và "tài khoản bị khóa" dù backend đã phân biệt qua status code — **xác nhận qua thực thi** (Login.jsx:17-19) | Medium       | TODO         | [LOGIN-S05.png](screenshot/LOGIN-S05.png) |
| BUG-GUI-19 | LOGIN-F07          | Label "Username"/"Mật khẩu" không có `for`/`htmlFor` liên kết input, ảnh hưởng accessibility — **xác nhận qua thực thi**          | Low          | TODO         | [LOGIN-F07.png](screenshot/LOGIN-F07.png) |
| BUG-GUI-20 | LOGIN-F08          | Không validate định dạng email do dùng `type="text"`, request sai định dạng vẫn được gửi lên server — **xác nhận qua thực thi** (hệ quả trực tiếp của BUG-GUI-11) | Low          | TODO         | [LOGIN-F08.png](screenshot/LOGIN-F08.png) |
| BUG-GUI-21 | HOME-U11, LOGIN-U06 | Không hỗ trợ Dark mode ở cả 2 trang (không có biến thể `dark:` trong Tailwind) — **xác nhận qua thực thi**                        | Low          | TODO         | [HOME-U11.png](screenshot/HOME-U11.png), [LOGIN-U06.png](screenshot/LOGIN-U06.png) |
| BUG-GUI-22 | HOME-S04           | Không có phản hồi trực quan (toast/badge) khi bấm "Thêm vào giỏ" trên trang Home — **xác nhận qua thực thi**                       | Medium       | TODO         | [HOME-S04.png](screenshot/HOME-S04.png) |
| BUG-GUI-23 | HOME-U12           | RTL layout không được xử lý chủ động: khi `dir="rtl"`, trình duyệt tự mirror toàn bộ bố cục (navbar, tiêu đề, ô tìm kiếm đổi vị trí) do thiếu logical properties — **xác nhận qua xem ảnh chụp** | Low          | TODO         | [HOME-U12.png](screenshot/HOME-U12.png) |
| BUG-GUI-24 | HOME-U13           | Màu giá sản phẩm (`text-red-500`/`text-red-600`) trên nền trắng không đạt tỉ lệ tương phản WCAG AA (~3.0–4.0:1 so với ngưỡng 4.5:1) — cùng vấn đề đã ghi nhận ở ProductDetail (PD-A03) | Low          | TODO         | [HOME-U13.png](screenshot/HOME-U13.png) |
| BUG-GUI-25 | HOME-F08           | Tìm kiếm với khoảng trắng đầu/cuối cho kết quả khác với từ khóa đã trim, do `server.js:144` không `trim()` chuỗi trước khi nối vào `LIKE` — hệ quả trực tiếp của lỗ hổng nối chuỗi đã ghi ở BUG-GUI-07 | Low          | TODO         | [HOME-F08.png](screenshot/HOME-F08.png) |
| BUG-GUI-26 | HOME-N05           | Tab order không theo thứ tự thị giác trên xuống/trái sang phải: link "Xem chi tiết" của card nhận focus trước ô tìm kiếm, vi phạm FR-21 — **xác nhận qua xem ảnh chụp + đối chiếu HOME-F07** | Low          | TODO         | [HOME-N05.png](screenshot/HOME-N05.png) |
| BUG-GUI-27 | HOME-N09           | Click "Thêm vào giỏ" khi chưa đăng nhập không có phản hồi nào (không toast, không redirect, không giỏ khách) — im lặng thất bại, vi phạm nguyên tắc feedback rõ ràng | Medium       | TODO         | [HOME-N09.png](screenshot/HOME-N09.png) |
| BUG-GUI-28 | LOGIN-N04          | `tabIndex={1}` gán cứng trên nút submit (Login.jsx:56) khiến nút có thể nhận Tab-focus trước các input phía trên (không có `tabIndex` khai báo, mặc định 0), phá vỡ tab order tuần tự tự nhiên | Low          | TODO         | [LOGIN-N04.png](screenshot/LOGIN-N04.png) |
| BUG-GUI-29 | LOGIN-N06          | Trạng thái mâu thuẫn: navbar hiển thị đã đăng nhập ("Chào, Test User" + nút Thoát) trong khi thân trang `/login` vẫn hiển thị form đăng nhập trống — do route `/login` không có guard chống truy cập khi đã đăng nhập | Medium       | TODO         | [LOGIN-N06.png](screenshot/LOGIN-N06.png) |
| BUG-GUI-30 | LOGIN-S08          | Double-submit đăng nhập: hệ quả trực tiếp của BUG-GUI-15/LOGIN-S02 (nút không disable khi đang gọi API) — mỗi lần click thêm trong lúc request đầu chưa hoàn tất có thể kích hoạt thêm 1 request `POST /api/login` trùng lặp | Low          | TODO         | [LOGIN-S08.png](screenshot/LOGIN-S08.png) |
...
>
> Trước khi nộp bài: tạo GitHub Issue cho từng bug ở trên, đính kèm ảnh chụp tương ứng (đã có sẵn tại [`hw3/screenshot/`](screenshot/), link trong cột Screenshot ở bảng trên), rồi điền lại cột GitHub Issue.
...
- Trước khi nộp bài, vẫn **bắt buộc**:
  ...
  4. Tạo GitHub Issues cho từng bug đã xác nhận (mục 1.6, 2.5) — dùng file [`hw3/bug_reports.md`](bug_reports.md) (đã tạo sẵn, mỗi bug 1 khối Title + Description sẵn sàng copy) — đính screenshot (đã có sẵn tại [`hw3/screenshot/`](screenshot/), link trong cột Screenshot của bảng 1.6), rồi điền lại cột GitHub Issue.
