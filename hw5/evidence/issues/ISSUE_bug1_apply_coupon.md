...
| Trước khi áp mã | Sau khi áp mã |
| --- | --- |
| ![Trước](bug1_01_truoc_khi_ap_ma.png) | ![Sau](bug1_02_sau_khi_ap_ma_TOAN_MAN_HINH.png) |

Khối kết quả coupon (phóng to):

![Khối kết quả](bug1_03_khoi_ket_qua_coupon.png)
...
Trong toàn bộ 594.134 sample của HW05 (Load / Stress / Spike / Endurance), endpoint này **luôn trả HTTP 200 và luôn PASS mọi assertion**, vì assertion chỉ kiểm tra *có tồn tại* trường `final_amount` chứ không kiểm tra *giá trị* của nó. Đây là minh chứng cho việc một pipeline hiệu năng "xanh" hoàn toàn không bảo đảm tính đúng đắn về mặt chức năng.
