...
| # | Bug ID | TC ID | Feature | Mức độ | Ảnh cần chèn | Tiêu đề ngắn |
|---|--------|-------|---------|--------|--------------|--------------|
| 1 | BUG-04 | TC-PROFILE-12 | FR-04 | **Critical** | `selenium/bug-snapshots/TC-PROFILE-12.png` | Leo thang đặc quyền qua `PUT /api/users/me` |
| 2 | BUG-07 | TC-CHECKOUT-07 | FR-08 | **Critical** | `selenium/bug-snapshots/TC-CHECKOUT-07.png` | Khách tự sửa được tổng tiền đơn hàng |
| 3 | BUG-11 | TC-ADMIN-12 | FR-18 | **Critical** | `selenium/bug-snapshots/TC-ADMIN-12.png` | Mọi API `/api/admin/*` không kiểm `role` |
| 4 | BUG-01 | TC-PROFILE-04 | FR-04 | High | `selenium/bug-snapshots/TC-PROFILE-04.png` | SĐT hợp lệ 10 chữ số bị từ chối |
| 5 | BUG-02 | TC-PROFILE-05 | FR-04 | High | `selenium/bug-snapshots/TC-PROFILE-05.png` | SĐT hợp lệ 11 chữ số bị từ chối |
| 6 | BUG-06 | TC-CHECKOUT-04 | FR-08 | High | `selenium/bug-snapshots/TC-CHECKOUT-04.png` | Công thức giảm giá percent bị đảo dấu |
| 7 | BUG-09 | TC-CHECKOUT-16 | FR-08 | High | `selenium/bug-snapshots/TC-CHECKOUT-16.png` | Giỏ rỗng vẫn tạo được đơn hàng |
| 8 | BUG-10 | TC-ADMIN-07 | FR-18 | High | `selenium/bug-snapshots/TC-ADMIN-07.png` | Cho phép `canceled → delivered` |
| 9 | BUG-12 | TC-ADMIN-14 | FR-18 | High | `selenium/bug-snapshots/TC-ADMIN-14.png` | XSS lưu trữ ở địa chỉ giao hàng |
| 10 | BUG-03 | TC-PROFILE-08 | FR-04 | Medium | `selenium/bug-snapshots/TC-PROFILE-08.png` | SĐT không bắt đầu bằng `0` lại được chấp nhận |
| 11 | BUG-05 | TC-CHECKOUT-03 | FR-08 | Medium | `selenium/bug-snapshots/TC-CHECKOUT-03.png` | Giỏ hàng không được xóa sau thanh toán |
| 12 | BUG-08 | TC-CHECKOUT-13 | FR-08 | Medium | `selenium/bug-snapshots/TC-CHECKOUT-13.png` | Lỗi biên ngưỡng coupon (`>` thay vì `>=`) |
| 13 | BUG-13 | TC-ADMIN-16 | FR-18 | Medium | `selenium/bug-snapshots/TC-ADMIN-16.png` | UI hiện nút chuyển tiếp ở trạng thái kết thúc |
...
## Sau khi tạo xong 13 issue

1. **Điền URL issue** vào cột `GitHub Issue` ở §1.9 [`Main_Report.md`](Main_Report.md) — hiện đang là `TBD`.
2. **Điền URL issue** vào [`selenium/bug-snapshots/BUGS.md`](selenium/bug-snapshots/BUGS.md) — cũng đang là `TBD`.
3. Cập nhật dòng **"Số GitHub Issue đã tạo"** ở §4 `Main_Report.md` và ở [`README.md`](README.md) — hiện ghi `0`.
4. Chụp màn hình trang Issues, lưu vào thư mục `github_issues/` như cấu trúc gói nộp trong `README.md` yêu cầu.
